...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5">
                <div class="card-header bg-dark text-light">Add New User</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Department</label>

                            <div class="col-md-6">
                                
                                {!! Form::select('department_id', $departments, null, ['class'=>'departmentSelect2 form-control']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                {!! Form::select('role_id', $roles, null, ['class'=>'departmentSelect2 form-control']) !!}
